 ...
 */
/**
 * Esta clase contiene variables y constructores que apoyan la creación de
 * métodos
 */
public class Cliente extends Usuario implements InterfazReservas, InterfazPago, NewInterface {
    ...
    /**
     * Este método permite al cliente reservar un Hotel ó departamento en base a
     * la ciudad seleccionada, y preferencias del usuario
     */
    @Override
...
//        
    ...
    /**
     * Este método permite al cliente reservar un transporte según la capacidad
     * deseada
     */
    @Override
    ...
    /**
     * Este método permite al cliente reservar paquete de entretenimiento,
     * basandose en la ciudad seleccionada
     *
     */
    @Override
